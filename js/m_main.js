...
*/
	$.ajax({
		...
		success: function(response){
			...
			if (response == "Y")
			{
				$.colorbox({innerWidth:"100%", initialWidth:"95%", innerHeight:'100%', inline:true, opacity:"0", scrolling:false, closeButton:false, overlayClose: true, fadeOut: 300, href:"#reg_pic_popup", onComplete: function(){
					$("#cboxContent").css("background","none");
					$("#colorbox").width($("body").width());
					$("#cboxWrapper").width($("body").width());
				},
